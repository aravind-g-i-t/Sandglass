...
userRoute.patch('/cart/quantity', auth.isLoggedIn, cartController.quantityUpdate);
userRoute.delete('/cart/remove_product', auth.isLoggedIn, cartController.removeProduct);
userRoute.post('/wishlist', auth.isLoggedIn, wishlistController.addToWishlist);
userRoute.delete('/wishlist/:productId', auth.isLoggedIn, wishlistController.removeFromWishlist);
